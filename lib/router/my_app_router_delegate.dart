...
import 'package:sample_app/data/auth_repository.dart';
import 'package:sample_app/data/colors_repository.dart';
import 'package:sample_app/router/pages/color_page.dart';
import 'package:sample_app/router/pages/home_page.dart';
import 'package:sample_app/router/pages/login_page.dart';
import 'package:sample_app/router/pages/shape_page.dart';
import 'package:sample_app/router/pages/splash_page.dart';
